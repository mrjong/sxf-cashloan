...
var gitCommitVersion = gitVersion ? gitVersion : gitHEAD;
...
let getProdPlugins = function() {
	...
	console.log(sentryVersion, 'sentryVersion');
	...
	plugins.push(
		new webpack.DefinePlugin({
			...
			saUrl: JSON.stringify('https://sa.vbillbank.com/sa/sa?project=production')
		})
	);
	plugins.push(
