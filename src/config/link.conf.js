/*
 * @Author: shawn
 * @LastEditTime : 2020-02-08 17:40:07
 */
/**
 * 外链url配置
 */
...
const envMap = {
	dev: {
		...
		PDF_URL: 'https://lns-api-test.vbillbank.com/wap', // pdf预览的接口url
	...
	pro: {
		...
		PDF_URL: 'https://lns-api.vbillbank.com/wap', // pdf预览的接口url
	...
	rc: {
		MD_URL: 'https://fbds-test.vbillbank.com',
		DC_URL: 'https://ffp.vbillbank.com/lender/common/ServiceAuthorization?MPOS_APP', // 生产地址
		PDF_URL: 'https://lns-api-rc.vbillbank.com/wap', // pdf预览的接口url
