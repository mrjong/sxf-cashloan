	...
	render() {
		...
		return (
			<div className={styles.main}>
				...
				{!(urlData && urlData.mposEntry) ? <div className={styles.spaceBlock}></div> : null}
				<div className={styles.redBagCont}>
					...
					<Carousel
						className={styles.awardListCarousel}
						vertical
						dots={false}
						dragging={false}
						swiping={false}
						...
						<div className={styles.modalWrapper}>
							<div>
								...
								<ol>
									...
									<li>
										2）活动期间借款3个月及以上期限的用户，可获得现金返现奖励，借款额度越高，返现金额越大，888元封顶（可提现）；
									</li>
					...
					<div className={styles.modal}>
						...
						<div className={`${styles.modalWrapper} ${styles.modalWrapper3}`}>
							<div className={styles.noAwardModalCont}>
								...
								<ButtonCustom className={styles.joinBtn} onClick={this.joinNow}>
									立即参与
								</ButtonCustom>
							</div>
