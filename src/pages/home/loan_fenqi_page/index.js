...
export default class loan_fenqi_page extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      loanDate: '',
      loanMoney: '',
      resaveBankCardAgrNo: '1',
      resaveBankCardLastNo: '1234',
      resaveBankCardName: '招商银行',
      payBankCardAgrNo: '2',
      payBankCardLastNo: '1234',
      payBankCardName: '招商银行',
      perdRateList: [],
      // submitData: {
      //   loanMoney: '',
      //   loanDate: '',
  ...
  //查询产品基本信息
  queryProdInfo = () => {
    this.props.$fetch.post(API.prodInfo, {
      channelType: 'h5'
    }).then(res => {
