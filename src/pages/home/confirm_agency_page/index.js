      ...
      <div>
        <div className={[style.confirm_agency, 'confirm_agency'].join(' ')}>
            ...
            <div className={style.inputWrap}>
              <div className={style.billInpBox}>
                ...
                <InputItem
                  ...
                  placeholder={repaymentDate.maxAmt ? `${repaymentDate.minAmt}-${repaymentDate.maxAmt}可借` : ''}
                  onBlur={v => {
                    setTimeout(() => {
                      if (!closeBtn) {
                        return;
              ...
              <ul className={style.pannel}>
                ...
                <li className={style.listItem}>
                  ...
                  <span className={style.listValue}>
                    ...
                    {repayInfo && repayInfo.prdList && repayInfo.prdList[0] && repayInfo.prdList[0].periodUnit === 'M'
                      ? '个月'
                      : '天'}
                  </span>
                </li>
          ...
          <div className={style.buttonWrap}>
            <SXFButton
              onClick={this.props.form.getFieldProps('cardBillAmt') && !disabledBtn ? this.handleButtonClick : () => {}}
              className={
