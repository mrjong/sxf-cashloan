			...
			<div className={[ style.pageWrapper, 'loan_repay_confirm_page' ].join(' ')}>
					...
					<div className={style.top}>
						...
						{isShowProgress ? (
							<div className={style.progressWrap}>
								<span className={style.percentTitle}>
									账单导入中 <em className={style.percentNum}>{percent}%</em>
								</span>
							...
							<span onClick={this.goMoxieBankList} className={style.updateButton}>
								{this.state.retryCount === 0 ? '重新更新' : '更新账单'}
							</span>
						)}
					</div>
				...
				<div>
					{getFieldDecorator('loanMoney', {
						...
						<InputItem
							placeholder={`申请金额${selectedLoanDate && selectedLoanDate.factLmtLow}-${selectedLoanDate &&
