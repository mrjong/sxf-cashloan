 ...
 * @LastEditTime : 2020-01-02 16:16:41
 */
...
const MiniprogramLoginPage = Loadable({
	loader: () => import('pages/login/miniprogram_login_page'),
	loading: Loading,
	LoadingComponent,
	delay: 300
});
	...
	render() {
		return (
			<Switch>
				...
				<Route path="/miniprogram_login" component={MiniprogramLoginPage} />
			</Switch>
		);
	}
}
