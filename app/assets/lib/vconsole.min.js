	...
	return (function(e) {
			...
			var u = o(9),
				...
				m = (function() {
					function e() {
						...
						'complete' == document.readyState ? o() : d['default'].bind(window, 'load', o);
					}
					return (
						l(e, [
							{
								...
								value: function() {
									...
									d['default'].bind(t, 'touchstart', function(t) {
										...
										d['default'].bind(d['default'].one('.vc-mask', e.$dom), 'click', function(t) {
											return t.target != d['default'].one('.vc-mask') ? !1 : void e.hide();
										}),
										d['default'].delegate(
										...
										e.trigger('addTool', function(t) {
											if (t)
												for (var o = d['default'].one('.vc-tool-last'), n = 0; n < t.length; n++) {
													...
													1 == r.global && d['default'].addClass(i, 'vc-global-tool'),
														a.isFunction(r.onClick) && d['default'].bind(i, 'click', r.onClick),
							...
							},
							{
								...
								value: function(e) {
									return void 0 !== this.pluginList[e.id]
										? (console.warn('Plugin ' + e.id + ' has already been added.'), !1)
										: ((this.pluginList[e.id] = e), this.isReady && this._initPlugin(e), !0);
								}
							},
							{
								key: 'show',
							...
							},
							{
								...
								value: function(e) {
									...
									d['default'].removeClass(d['default'].all('.vc-tab', this.$dom), 'vc-actived'),
										d['default'].addClass(d['default'].one('#__vc_tab_' + e), 'vc-actived'),
										d['default'].removeClass(d['default'].all('.vc-logbox', this.$dom), 'vc-actived'),
										d['default'].addClass(t, 'vc-actived'),
										(d['default'].one('.vc-content', this.$dom).scrollTop = d['default'].one(
											'.vc-content',
											this.$dom
										).scrollHeight),
										d['default'].removeClass(d['default'].all('.vc-tool', this.$dom), 'vc-actived'),
										d['default'].addClass(d['default'].all('.vc-tool-' + e, this.$dom), 'vc-actived'),
		...
		function(e, t) {
			...
			function o(e) {
				...
				return (
					100 > a && (a = '0' + a),
					{ time: +t, year: r, month: n, day: o, hour: i, minute: l, second: c, millisecond: a }
				);
			}
			function n(e) {
			...
			function f(e) {
				return 'object' === ('undefined' == typeof HTMLElement ? 'undefined' : h(HTMLElement))
					...
					(e.i = function(t, o) {
						...
						for (r = 0; r < t.length; r++) {
							...
							('number' == typeof l[0] && n[l[0]]) ||
								(o && !l[2] ? (l[2] = o) : o && (l[2] = '(' + l[2] + ') and (' + o + ')'), e.push(l));
						}
					}),
					e
				);
		...
		function(e, t, o) {
			...
			function s(e, t) {
				...
				if (t.singleton) {
					var i = y++;
					(o = h || (h = c(t))), (n = d.bind(null, o, i, !1)), (r = d.bind(null, o, i, !0));
				} else
					e.sourceMap &&
					'function' == typeof URL &&
				...
				VConsoleDefaultTab = (function(_VConsoleLogTab) {
					function VConsoleDefaultTab() {
						...
						var r = _possibleConstructorReturn(
							this,
							(e = Object.getPrototypeOf(VConsoleDefaultTab)).call.apply(e, [this].concat(o))
						);
							...
							},
							{
								...
								value: function evalCommand(cmd) {
									...
									(content =
										...
										this.renderLog({ logType: 'log', meta: '', content: content, style: 'vc-item-nometa' });
								}
							}
						]),
						VConsoleDefaultTab
						...
						s(t, [
							{
								key: 'onInit',
								value: function() {
									(this.isReady = !0), (this.$tabbox = v['default'].render(this.tplTabbox, {}));
								...
								value: function() {
									...
									window.console
										...
										(window.onerror = function(e, t, o, n, r) {
											...
											(i = i[0] + ' ' + i[1]), (i = i.replace(location.origin, '')), console.error(i);
										});
								}
							},
							{
							...
							},
							{
								...
								value: function(e) {
									...
									if (t.length) {
										...
										if ((r ? (o = r == this.id) : 0 == this.allowUnformattedLog && (o = !1), !o))
							...
							},
							{
								...
								value: function(e) {
									function t(e) {
										for (var t = s.length - 1; t >= 0; t--) if (s[t].child == e) return !0;
										return !1;
									}
									function o(e, n) {
										if (u.isObject(e)) {
											...
											for (var l = 0; l < r.length; l++) {
												...
												e.hasOwnProperty(d) &&
													((i +=
														Array(c + 1).join(a) +
														v['default'].render(x['default'], { type: 'key', code: d }, !0) +
														': '),
													o(e[d], e),
													l < r.length - 1 && (i += ',\n'));
											}
											...
											for (var f = 0; f < e.length; f++)
												(i +=
													Array(c + 1).join(a) +
													v['default'].render(x['default'], { type: 'key', code: f }, !0) +
													': '),
													o(e[f], e),
													f < e.length - 1 && (i += ',\n');
											c--, (i += '\n' + Array(c + 1).join(a) + ']'), s.pop();
											...
											i += u.isString(e)
												? v['default'].render(
														x['default'],
														{ type: 'string', code: '"' + u.htmlEncode(e) + '"' },
														!0
												  )
												: u.isNumber(e)
												? v['default'].render(x['default'], { type: 'number', code: e }, !0)
												: u.isBoolean(e)
												? v['default'].render(x['default'], { type: 'boolean', code: e }, !0)
												: u.isNull(e)
												? v['default'].render(x['default'], { type: 'null', code: 'null' }, !0)
												: u.isUndefined(e)
												? v['default'].render(x['default'], { type: 'undefined', code: 'undefined' }, !0)
												: u.isFunction(e)
												? v['default'].render(x['default'], { type: 'function', code: 'function()' }, !0)
												: JSON.stringify(e);
									}
						...
						a(t, [
							...
							},
							{
								...
								value: function() {
									...
									(t = 'Unknown'),
										a && a[0] && ((a = a[0].split('/')), (t = a[1]), console.info('[system]', 'Network:', t)),
										(t = 'Unknown'),
										(t =
									...
									if (s && s.timing) {
										...
										console.info('[system]', 'connectEndTime:', d.connectEnd - f + 'ms'),
											...
											d.secureConnectionStart > 0 &&
												console.info('[system]', 'SSL Cost:', d.connectEnd - d.secureConnectionStart + 'ms'),
							...
							},
							{
								...
								value: function(e, t) {
									...
									var l = d['default'].render(_['default'], i),
										c = this.domList[e];
									n.status >= 400 &&
										d['default'].addClass(d['default'].one('.vc-group-preview', l), 'vc-table-row-error'),
										c
											...
											return (
												(e.onreadystatechange = function() {
													...
													if (
														...
														o.header = {};
														for (
															var n = e.getAllResponseHeaders() || '', c = n.split('\n'), a = 0;
															a < c.length;
															a++
														) {
															var s = c[a];
